...
module.exports.run = async (client, message, args, prefix) => {
    ...
    const resource = createAudioResource('https://25353.live.streamtheworld.com/RADIO538.mp3?dist=nederlandfmnl_mob');
    ...
    const embed = new EmbedBuilder()
        .setTitle(`Ik speel nu radio 538`)
        .setDescription(`radio 538 aangezet \n\nin kanaal <#${message.member.voice.channel.id}>`)
