...
module.exports.run = async (client, message, args, prefix) => {
    ...
    const resource = createAudioResource('https://25683.live.streamtheworld.com/VERONICA.mp3?dist=nederlandfmnl_mob');
    ...
    const embed = new EmbedBuilder()
        .setTitle(`Ik speel nu Veronica`)
        .setDescription(`Veronica aangezet \n\nin kanaal <#${message.member.voice.channel.id}>`)
